...
table = read.xlsx(file, sheetName = "P(1e-6)")

intron = table[grep("intron", table$Consequence), ]
(intron_gene = unique(intron$SYMBOL))

file = "~/Dropbox/GitHub/wgs/resources/GWAS_catelog/gwas_catalog_v1.0-downloaded_2015-07-22.tsv"
gwascat <- read.delim(file)
names(gwascat)
...
out = gwas_select[c("PUBMEDID", "DISEASE.TRAIT", "REGION", "CHR_ID", "CHR_POS", "REPORTED.GENE.S.", "MAPPED_GENE", "SNPS", "CONTEXT", "P.VALUE", "OR.or.BETA")]

write.xlsx(out, file = "./Manu/tables/Supp_Table2.xlsx", sheetName = "NHGRI GWAS OVERLAP")
