...
rm(list = ls())
load("~/gitHub/Genetics/igap/igap_t1k.rdt")

igap = igap_t1k$igap
geno = igap_t1k$geno

all(rownames(igap) %in% rownames(geno))
...
save(igap_s1, igap_s1s2, glmm, file = "~/GitHub/gwas/igap/igap.rdt")

setwd("/data/xwang/glmm")
